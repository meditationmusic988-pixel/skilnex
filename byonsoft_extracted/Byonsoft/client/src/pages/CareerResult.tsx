...
export default function CareerResult() {
  ...
  const waText = result
    ? `🚀 AI ne mujhe ye career path recommend kiya!\n\n🎯 *${result.skill_path}*\n💰 6-month income: ${result.income_6m}\n⭐ Sirf ${result.rarity}% users ko ye result milta hai!\n\n📊 Mera result card dekho aur apna free test do:\n👉 ${shareUrl}`
    : "";
      ...
      <div className="min-h-screen bg-[#070D18] flex flex-col items-center justify-center text-white px-4">
        <div className="text-center max-w-sm">
          ...
          <div className="mt-6 space-y-2 text-xs text-slate-500">
            <p>✓ Processing skill scores</p>
            <p>✓ Matching career paths</p>
            <p className="animate-pulse text-blue-400">⟳ Generating income projections...</p>
          </div>
        </div>
      </div>
    );
        ...
        {(roadmap.month1 || roadmap.month2 || roadmap.month3) && (
          <div className="rounded-2xl border border-white/5 bg-[#0D1626]/60 p-6">
            ...
            <div className="space-y-4">
              {[
                { month: "Month 1", content: roadmap.month1, color: "blue", icon: "📚" },
                { month: "Month 2", content: roadmap.month2, color: "cyan", icon: "🏗️" },
                { month: "Month 3", content: roadmap.month3, color: "emerald", icon: "🚀" },
        ...
        <div className="rounded-2xl border border-white/8 bg-[#0A1020] overflow-hidden shadow-2xl">
          ...
          >
            <img
              ...
              alt={`${result.skill_path} — Career Result Card`}
        ...
        {user && (
          <div className="rounded-xl border border-blue-500/15 bg-blue-900/10 p-4 flex items-center gap-3">
            ...
            <p className="text-slate-400 text-sm">
              Share this result and if <strong className="text-white">2 friends subscribe</strong>, you earn an extra <strong className="text-yellow-300">giveaway ticket 🎟️</strong>. 
              <Link href="/dashboard" className="text-blue-400 hover:text-blue-300 ml-1">Check your referral stats →</Link>
            </p>
          </div>
        )}
